...
case ${ENV} in
  "0")
  curl -L https://raw.githubusercontent.com/YWJamesLin/zsh_env_generate/master/common/zsh/zshrc_user >> ~/.zshrc
  ;;
  "1")
  curl -L https://raw.githubusercontent.com/YWJamesLin/zsh_env_generate/master/common/zsh/zshrc_root >> ~/.zshrc
  ;;
esac
